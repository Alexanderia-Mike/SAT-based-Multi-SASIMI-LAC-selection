////
//// Created by 娄辰飞 on 2021/3/17.
////
//
//#include "strashtest.h"
//#include "cktUtil.h"
//
////int main(int argc, char * argv[]) {
////    Abc_Ntk_t * pMUXedNtk = Io_Read( "appNtk/Alexanderia_MUXAdded.blif", IO_FILE_BLIF, 0, 0 );
...
//{
//    parser option;
//    option.add <string> ("input", 'i', "original circuit file", false, "appNtk/Alexanderia_MUXAdded.blif");
...
//    Abc_Ntk_t * pNtkMUXedStrash = Abc_NtkStrash( pNtk, 0, 0, 0 );
//
//    // stop abc
//    Abc_Stop();
//
