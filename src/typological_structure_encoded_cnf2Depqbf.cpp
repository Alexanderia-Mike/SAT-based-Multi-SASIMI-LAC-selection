...
static void QDPLL_AddQuantifiers( QDPLL * depqbf, int * OriPIIDs, int * MUXPIIDs, int * structure_code_ids, int nVars );
...
void Cnf_DataFile2Depqbf( char * pFileName, QDPLL * depqbf, int * OriPIIDs, int * MUXPIIDs, int * structure_code_ids )
{
    ...
    // create quantifiers
    QDPLL_AddQuantifiers( depqbf, OriPIIDs, MUXPIIDs, structure_code_ids, nVars );
...
static void QDPLL_AddQuantifiers( QDPLL * depqbf, int * OriPIIDs, int * MUXPIIDs, int * structure_code_ids, int nVars )
{
    ...
    /* for new structural bits begin */
    for ( int i = 0; i < structure_code_ids[0]; ++i )
    {
        qdpll_add( depqbf, structure_code_ids[i+1] );
    }
    /* for new structural bits end */
    qdpll_add( depqbf, 0 );
